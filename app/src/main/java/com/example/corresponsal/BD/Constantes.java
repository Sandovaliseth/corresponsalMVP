...
public class Constantes {
    ...
    public static final String TABLE_PAGOS = "t_pagoTarjeta";
    ...
    public static final String CREAR_PAGO = "CREATE TABLE " + TABLE_PAGOS + "(id INTEGER PRIMARY KEY AUTOINCREMENT, numeroTarjeta INTEGER, fechaExpiracion INTEGER, CVV INTEGER, nombreCliente CLIENTE, cuotas INTEGER, valorPagar DOUBLE)";
